...
@com.qualcomm.robotcore.eventloop.opmode.Autonomous(name="Auto8582")
public class Auto8582 extends LinearOpMode {
...
*/
    ...
    public void sideDrive(double speed, double leftInches, double rightInches, double timeoutS) throws InterruptedException {
        int newLeftTarget; //declare variable for the target position of the left motor
        int newRightTarget; //declare variable for the target position of the right motor
        ...
        if (opModeIsActive()) {
            ...
            //sets the motors to run to the position corresponding to their side (left or right)
            robot.leftDrive.setTargetPosition(newRightTarget);
